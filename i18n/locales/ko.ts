export const koTranslation = {
  ...
  "onboarding": {
    ...
    "slides": {
      "sopPos": {
        "title": "SOP 대 POS",
        "description": "SOP는 1을 사용해 최소화하고, POS는 0을 사용해 최소화합니다. 위에서 유형을 변경해 필요한 형식으로 풀어 보세요."
      },
      "values": {
        "title": "0 / 1 / X 변경",
        "description": "각 셀을 탭하여 0 → 1 → X로 순환합니다. 퀵 버튼을 사용하면 한 번의 탭으로 전체 맵을 채울 수 있습니다."
      },
      "circuit": {
        "description": "결과를 실시간 회로로 확인하세요. 표준·NAND·NOR·MUX·디코더를 전환하고, 항을 탭하면 그룹이 강조됩니다.",
        "title": "회로 읽기"
      },
      "steps": {
        "title": "단계별로 배우기",
        "description": "그룹을 하나씩 공개하며 각 그룹이 형성되는 이유와 제거되는 변수를 설명합니다."
      },
      "tools": {
        "title": "더 빠르게",
        "description": "ƒ(x)로 불 식에서 맵을 자동으로 채우고, 문제를 링크로 친구와 공유하세요."
      }
    },
    "title": "시작하기"
  }
